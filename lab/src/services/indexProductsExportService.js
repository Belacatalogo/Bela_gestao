...
function buildTabCounts(products) {
  const counts = {};
  products.forEach((product) => (product.catalogTabs?.length ? product.catalogTabs : ['sem-aba']).forEach((tab) => {
